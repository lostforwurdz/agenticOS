...
## Agents Used
1. `tester` - Write tests first (TDD)
...
1. tester: Create tests for expected behavior
2. coder: Implement feature to pass tests
...
2. **Test first** - Let tester define the contract
